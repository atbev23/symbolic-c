...
ast_node_t* sub_to_add(ast_node_t*, token_pool_t*, node_pool_t*);
ast_node_t* div_to_mul(ast_node_t*, token_pool_t*, node_pool_t*);
ast_node_t* neg_to_mul(ast_node_t*, token_pool_t*, node_pool_t*);
ast_node_t* simplify(ast_node_t*, token_pool_t*, node_pool_t*);    // performs "math rules" to simplify the ast
